...
echo ' <nav class="mobile_nav_desplegable" id="menu_desplegable">
        ...
        if(isset($_SESSION['email']) && $_SESSION['estado'] == 'OK' && $_SESSION['tipo_usuario'] == 'administrador'){
            ...
            <p class="opciones_menu_letras"><a href="principal.php?pagina=main_añadir_tabla_users">LISTA DE USUARIOS</a></p>
            </div>
            ...
            <p class="opciones_menu_letras"><a href="principal.php?pagina=main_añadir_tabla_productos">LISTA DE PRODUCTOS</a></p>
            </div>
            ...
            <p class="opciones_menu_letras"><a href="principal.php?pagina=main_añadir_producto">AÑADIR PRODUCTO</a></p>
            </div>
            
            <div class="opciones_menu_desplegable gris" id="opcion_cerrar_sesion">
            <div class="contenedor_imagen_opcion_menu_desplegable"><i class="fa-solid fa-right-from-bracket masgrande"></i></div>
            <form action="principal.php" method="post" style="margin:0;">
                <button type="submit" name="cerrarsesion" class="" style="background:none;border:none;cursor:pointer;">
                <p class="opciones_menu_letras">CERRAR SESIÓN<p>
                </button>
            </form>
            </div>';
        }
          ...
          <div class="opciones_menu_desplegable">
           ...
           <a href="principal.php?pagina=main"><p class="opciones_menu_letras">TODOS LOS PRODUCTOS</p></a>
            </div>
            <div class="opciones_menu_desplegable">
                <div class="contenedor_imagen_opcion_menu_desplegable"><img src="images/icon_shoes_sneakers-svg.png" alt=""></div>
                <a href="principal.php?pagina=main_zapatillas"><p class="opciones_menu_letras">ZAPATILLAS</p></a>
            </div>
            <div class="opciones_menu_desplegable">
                <div class="contenedor_imagen_opcion_menu_desplegable"><img src="images/icon_tshirt10-svg.png" alt=""></div>
                <a href="principal.php?pagina=main_camisetas"><p class="opciones_menu_letras">CAMISETAS</p></a>
            </div>
            <div class="opciones_menu_desplegable">
                <div class="contenedor_imagen_opcion_menu_desplegable"><img src="images/icon_tshirt10-svg.png" alt=""></div>
                <a href="principal.php?pagina=main_abrigos"><p class="opciones_menu_letras">ABRIGOS</p></a>
            </div>
            <div class="opciones_menu_desplegable">
                <div class="contenedor_imagen_opcion_menu_desplegable"><img src="images/icon_cap-svg.png" alt=""></div>
                <a href="principal.php?pagina=main_accesorios"><p class="opciones_menu_letras">ACCESORIOS</p></a>
            </div>
            <div class="opciones_menu_desplegable gris" id="micuenta">
            <div class="contenedor_imagen_opcion_menu_desplegable"><i class="fa-solid fa-user masgrande"></i></div>
            <p class="opciones_menu_letras"><a href="principal.php?pagina=main_mi_cuenta">MI CUENTA</a></p>
            </div>
            </div>
            <div class="opciones_menu_desplegable gris" id="opcion_cerrar_sesion">
            <div class="contenedor_imagen_opcion_menu_desplegable"><i class="fa-solid fa-right-from-bracket masgrande"></i></div>
            <form action="principal.php" method="post" style="margin:0;">
                <button class="opciones_menu_letras" type="submit" name="cerrarsesion" class="maspadding" style="background:none;border:none;cursor:pointer;">
                CERRAR SESIÓN
                </button>
            </form>
            </div>';
        ...
        <div class="opciones_menu_desplegable gris" id="registrate_desplegable">
            <div class="contenedor_imagen_opcion_menu_desplegable"><i class="fa-solid fa-user masgrande"></i></div>
            <p class="opciones_menu_letras">MI CUENTA</p>
            </div>
            </div>';
